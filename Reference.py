...
# add text
# height = 1, width = 1, margins = 0.02(2%) all sides
...
def _build_education(education: Education):
...
education = Education()
education.header = EduHeader
education.title_list = [EduOneTitle, EduTwoTitle]
education.time_list = [EduOneTime, EduTwoTime]
education.description_list = [EduOneDesc]

_build_education(education)
...
plt.savefig('reference.png', dpi=300, bbox_inches='tight')
